...
const builders = [
    { id: 1, name: 'Lodha Group', desc: 'India\'s No. 1 real estate developer, known for redefining luxury living and creating iconic landmarks across Mumbai, including The Park and World Towers.', projects: 42, established: 1980, type: 'Ultra-Luxury & Premium', image: 'https://images.unsplash.com/photo-1545464593-3b1e938925ea?auto=format&fit=crop&q=80' },
    { id: 2, name: 'Godrej Properties', desc: 'Bringing the Godrej Group philosophy of innovation, sustainability, and excellence to the real estate industry with award-winning residential projects.', projects: 28, established: 1990, type: 'Premium Residential', image: 'https://images.unsplash.com/photo-1579625409549-342880afc3f9?auto=format&fit=crop&q=80' },
    { id: 3, name: 'Oberoi Realty', desc: 'Focused on developing residential, commercial, retail, and social infrastructure projects that offer a premium lifestyle and unmatched quality.', projects: 15, established: 1998, type: 'Luxury & Commercial', image: 'https://images.unsplash.com/photo-1554469384-e58fac16e23a?auto=format&fit=crop&q=80' },
    ...
    { id: 5, name: 'Rustomjee', desc: 'Renowned for thoughtful design and turning spaces into homes. A dominant player in the western suburbs and premium redevelopment projects.', projects: 35, established: 1996, type: 'Premium & Redevelopment', image: 'https://images.unsplash.com/photo-1460317442991-0ec209397118?auto=format&fit=crop&q=80' },
    { id: 6, name: 'K Raheja Corp', desc: 'Leading developers of premium residential, commercial (Mindspace), and retail (Inorbit) spaces with a strong commitment to green building.', projects: 22, established: 1956, type: 'Commercial & Retail', image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80' },
];
