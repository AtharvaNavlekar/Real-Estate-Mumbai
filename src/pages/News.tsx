                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {articles.map((article) => (
                        <Link to={`/news/${article.id}`} key={article.id}>
                            <motion.div whileHover={{ y: -5 }} className="bg-white rounded-3xl overflow-hidden shadow-lg shadow-black/5 border border-slate-100 group cursor-pointer flex flex-col h-full">
